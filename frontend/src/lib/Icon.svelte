...
{#if route.route_type === 'bus'}
	<div
		...
		class="relative text-lg w-fit p-1 text-white rounded font-bold shadow-2xl flex text-center justify-center [text-shadow:_1px_1px_2px_rgb(0_0_0_/_60%),_-1px_-1px_2px_rgb(0_0_0_/_60%)]"
		onclick={() => {
